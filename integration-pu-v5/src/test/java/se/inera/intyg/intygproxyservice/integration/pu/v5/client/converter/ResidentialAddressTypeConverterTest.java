...
import static se.inera.intyg.intygproxyservice.integration.pu.v5.TestData.CARE_OF;
...
import static se.inera.intyg.intygproxyservice.integration.pu.v5.TestData.POSTAL_ADDRESS2;
import static se.inera.intyg.intygproxyservice.integration.pu.v5.TestData.POSTAL_CODE;
import static se.inera.intyg.intygproxyservice.integration.pu.v5.TestData.addressInformationType;
import static se.inera.intyg.intygproxyservice.integration.pu.v5.client.converter.ResidentialAddressTypeConverter.city;
import static se.inera.intyg.intygproxyservice.integration.pu.v5.client.converter.ResidentialAddressTypeConverter.postalAddress;
import static se.inera.intyg.intygproxyservice.integration.pu.v5.client.converter.ResidentialAddressTypeConverter.postalCode;
...
class ResidentialAddressTypeConverterTest {
  ...
  private static Stream<Arguments> provideAddressCombinations() {
    return Stream.of(
        Arguments.of(addressInformationType(CARE_OF, null, null), CARE_OF),
        Arguments.of(addressInformationType(null, POSTAL_ADDRESS1, null), POSTAL_ADDRESS1),
        Arguments.of(addressInformationType(null, null, POSTAL_ADDRESS2), POSTAL_ADDRESS2),
        Arguments.of(
