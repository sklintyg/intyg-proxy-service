...
class CredentialsForPersonControllerTest {
  ...
  @Mock private CredentialsForPersonService credentialsForPersonService;

  @InjectMocks private CredentialsForPersonController credentialsForPersonController;
  ...
  void shallReturnCredentialInformationResponseWhenCallingGetCredentialInformation() {
    ...
    final var response =
        credentialsForPersonController.getCredentialsForPerson(
