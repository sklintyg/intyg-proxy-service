...
class FakeHsaGetLastUpdateIntegrationServiceTest {
  ...
  @InjectMocks private FakeHsaGetLastUpdateIntegrationService getLastUpdateIntegrationService;

  @Test
  void shouldReturnResponseWithLastUpdate() {
    final var localDateTime = LocalDateTime.now();
    final var expectedResponse =
        GetLastUpdateIntegrationResponse.builder().lastUpdate(localDateTime).build();
