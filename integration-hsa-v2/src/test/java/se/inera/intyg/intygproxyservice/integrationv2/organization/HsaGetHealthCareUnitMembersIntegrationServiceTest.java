 ...
 */
package se.inera.intyg.intygproxyservice.integrationv2.organization;
...
class HsaGetHealthCareUnitMembersIntegrationServiceTest {
  ...
  @InjectMocks
  private HsaGetHealthCareUnitMembersIntegrationService
      hsaGetHealthCareUnitMembersIntegrationService;

  @Mock private HsaOrganizationClient hsaOrganizationClient;
  ...
  void shouldReturnUnitMembers() {
    ...
    final var response =
        hsaGetHealthCareUnitMembersIntegrationService.get(
